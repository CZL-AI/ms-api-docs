      ...
      items: [
        {
          text: '流程开始',
          items: [
            { text: 'SessionStart', link: '/api/smart-consultation/session-start.md' }
          ]
        },
        {
          text: '问答环节',
          items: [
            { text: '获取问题 [流式]', link: '/api/smart-consultation/get-question-stream' },
            { text: '获取问题联想', link: '/api/smart-consultation/get-question-association' },
            { text: '保存用户回答', link: '/api/smart-consultation/save-user-answer' }
          ]
        },
        {
          text: '传图环节',
          items: [
            { text: '上传文件', link: '/api/smart-consultation/upload-file' },
            { text: '获取图片结果', link: '/api/smart-consultation/get-image-result' },
            { text: '是否需要上传图片', link: '/api/smart-consultation/is-image-upload-needed' }
          ]
        },
        {
          text: '继续提问',
          ...
          items: [
            ...
            { text: '获取问题联想', link: '/api/smart-consultation/get-question-association' },
            { text: '保存用户回答', link: '/api/smart-consultation/save-user-answer' },
            { text: '是否继续问答 [流式]', link: '/api/smart-consultation/is-continue-qa-stream' }
          ]
        },
        {
          text: '生成报告',
