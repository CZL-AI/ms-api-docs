...
**请求地址：** `https://ms-ai.chongzhiling.com/api/v2.0/ai-b/ai-voice-recg/analysis-by-url`

**英文版请求地址：** `https://ms-ai.chongzhiling.com/api/v2.0/ai-en/ai-voice-recg/analysis-by-url`
